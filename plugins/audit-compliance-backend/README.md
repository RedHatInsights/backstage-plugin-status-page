...
This plugin is installed via the `@appdev-platform/backstage-plugin-audit-compliance-backend` package. To install it to your backend package, run the following command:
